...
class ExchangeDiffCoins extends StatelessWidget{
  final String coupleName;
  final double volume;
  final double value;
  final double valueDol;
  final double profit;
  ExchangeDiffCoins({this.coupleName, this.volume, this.value, this.valueDol, this.profit });
    ...
    return Container(
        ...
        child: Row(
          ...
          children: <Widget> [
            ...
            Column(
              children: <Widget> [
                Text("- "+value.toStringAsFixed(2), style: tituloStyle3,),
